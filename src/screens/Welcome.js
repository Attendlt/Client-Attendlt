...
function Welcome() {
  ...
  <div className="poster">
    <nav className="navbar navbar-expand-lg navbar-primary">
      <a id="navbar-brand" style={{fontSize : "2em", color: "black"}} href><span style={{color:"crimson"}}>Attend</span>It</a>
    ...
    <div className="about">
      ...
      <h6>In current times, a safe Touchless entry for your employee is an important safety measure. Truein has been already leading in Face recognition technologies in the entrance domain from past 4 years. It's a robust, accurate and secure attendance system.</h6>
    </div>
  ...
  <div id="features" className="rows">
    ...
    <div className="cols">
      <div className="cards">
        ...
        <p>Runs on any Android or iOS device.</p>
      </div>
    </div>
    <div className="cols">
      <div className="cards">
